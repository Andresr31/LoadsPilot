@extends('layouts.app')
@section('title', 'Piloto Cargues - Editar producto')
        ...
        <div class="col-md-10 offset-md-1">
            ...
            <form action="{{ route('products.update',$product->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="material" type="text" class="form-control @error('material') is-invalid @enderror" name="material" value="{{ $product->material }}" required autofocus>
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="reference" type="text" class="form-control @error('reference') is-invalid @enderror" name="reference" value="{{ $product->reference }}" required autocomplete="reference" autofocus>
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="lote" type="text" class="form-control @error('lote') is-invalid @enderror" name="lote" value="{{ $product->lote }}" required autocomplete="lote" autofocus>
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="date_of_manufacture" type="date" class="form-control @error('date_of_manufacture') is-invalid @enderror" name="date_of_manufacture" value="{{ $product->date_of_manufacture }}" required autocomplete="date_of_manufacture" autofocus>
                ...
                <div class="mb-3">
                    ...
                    <div class="">
                        <input id="expiration_date" type="date" class="form-control @error('expiration_date') is-invalid @enderror" name="expiration_date" value="{{ $product->expiration_date }}" required autocomplete="expiration_date" autofocus>
